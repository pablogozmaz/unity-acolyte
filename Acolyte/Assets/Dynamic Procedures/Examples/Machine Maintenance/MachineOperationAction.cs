...
namespace TFM.DynamicProcedures.Examples
{
    ...
    public class MachineOperationAction : StepAction
    {
    ...
    public class MachineOperationActionExecution : StepActionExecution<MachineOperationAction>
    {
        ...
        protected override void InternalInitialization(Environment environment, MachineOperationAction action)
        {
